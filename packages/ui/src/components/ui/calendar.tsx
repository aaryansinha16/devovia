  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: cn(
          "bg-sky-500/20 rounded-l-md",
          defaultClassNames.range_start
        ),
        range_middle: cn("rounded-none", defaultClassNames.range_middle),
        range_end: cn(
          "bg-sky-500/20 rounded-r-md",
          defaultClassNames.range_end
        ),
        today: cn(
          "bg-slate-700 text-white rounded-md data-[selected=true]:rounded-none",
