...
const CursorBlobEffect: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const interactiveElements = document.querySelectorAll('a, button, [role="button"], input[type="submit"], input[type="button"], label[for], select, textarea');
  ...
  const currentCenterDotColor = theme === 'light' ? centerDotColorLight : centerDotColorDark;
