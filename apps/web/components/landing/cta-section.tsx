...
const CTASection: React.FC = () => {
  return (
    <section
      id="early-access"
      className="py-16 md:py-24 bg-sky-600/10 dark:bg-sky-700/20 cta-section"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 cta-content-wrapper">
        ...
        >
          <h2
            id="cta-heading"
            className="text-3xl sm:text-4xl font-extrabold tracking-tight text-slate-800 dark:text-slate-100 mb-4 section-title"
          >
          ...
          <p
            id="cta-subheading"
            className="max-w-xl mx-auto text-lg text-slate-600 dark:text-slate-300 mb-8 section-subtitle"
          >
            Sign up for early access to Devovia and be among the first to
            experience the future of developer productivity. Get exclusive
            updates and shape the platform with your feedback.
          </p>
          <form
            id="early-access-form"
            className="max-w-md mx-auto flex flex-col sm:flex-row gap-4 early-access-form-wrapper"
          ...
          <p
            id="cta-privacy-note"
            className="mt-6 text-sm text-slate-500 dark:text-slate-400 privacy-note"
          >
