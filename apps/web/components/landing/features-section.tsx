...
export const CodeBracketSquareIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  props,
) => (
  <svg
...
export const RectangleStackIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M6.429 9.75 2.25 12l4.179 2.25m0-4.5 5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-3.75 2.25M12 13.5l-3.75 2.25L12 18l3.75-2.25-3.75-2.25Zm-3.75 2.25 3.75 2.25m0 0 3.75-2.25m5.625-3 4.179-2.25-4.179-2.25m0 4.5 3.75 2.25 4.179-2.25-4.179-2.25m0 0L21.75 7.5 12 2.25l-9.75 5.25 3.75 2.25m11.142 0-5.571 3-5.571-3"
    />
  </svg>
);
...
export const WrenchScrewdriverIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.83-5.83M11.42 15.17l.75-.75a3.75 3.75 0 0 0-5.303-5.303l-.75.75M11.42 15.17L5.83 21M12.75 3h3.75M21 12.75V9A2.25 2.25 0 0 0 18.75 6.75h-3.75M16.5 3.75h.008v.008H16.5V3.75Z"
    />
  </svg>
);
...
export const CommandLineIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M6.75 7.5 3 12m0 0 3.75 4.5M3 12h18"
    />
  </svg>
);
...
export const FEATURES_DATA: Feature[] = [
  {
    ...
    description:
      "Instantly save, search, and share reusable code snippets. Tag, categorize, and collaborate with ease.",
  },
  {
    icon: RectangleStackIcon,
    title: "Rapid Project Templating",
    description:
      "Kickstart projects in seconds with pre-configured templates for various frameworks and languages.",
  },
  {
    icon: WrenchScrewdriverIcon,
    title: "Intuitive CI/CD Builders",
    description:
      "Visually construct and manage your CI/CD pipelines without the YAML headache.",
  },
  {
    icon: CommandLineIcon,
    title: "Curated Developer Toolkit",
    description:
      "Access a growing collection of essential utilities, linters, formatters, and converters directly.",
  },
];
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 features-content-wrapper">
        ...
        >
          ...
          >
            Devovia offers a suite of integrated tools designed to boost your
            productivity and streamline your development process.
          </p>
        </AnimatedElement>
