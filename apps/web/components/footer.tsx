...
const Footer: React.FC = () => {
    ...
    return (
        <footer id="site-footer" className="bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-700 main-footer">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 footer-container">
                <div className="flex flex-col md:flex-row justify-between items-center footer-content">
                    ...
                    <p id="copyright-text" className="text-sm text-slate-500 dark:text-slate-400">
                        &copy; {currentYear} Devovia. All rights reserved.
                    </p>
                    <div id="footer-links" className="flex space-x-4 mt-4 md:mt-0 legal-links">
                        <a href="#" className="text-slate-500 dark:text-slate-400 hover:text-sky-500 dark:hover:text-sky-400 transition-colors footer-link">Privacy Policy</a>
                        <a href="#" className="text-slate-500 dark:text-slate-400 hover:text-sky-500 dark:hover:text-sky-400 transition-colors footer-link">Terms of Service</a>
                    </div>
                </div>
            </div>
        </footer>
